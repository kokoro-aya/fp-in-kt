...
object Console {
    ...
    /**
     * A simpler implementation of readLine. A function reference is not possible due to the name clash.
     * Use different names for fun and val functions if you want to use function references
     */
